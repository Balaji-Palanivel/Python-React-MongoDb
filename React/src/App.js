      ...
      <div>
        <div className='row'>
          <div className="input-group" style={{ Left: "10px" }}>
            <div id="search-autocomplete" className="col-sm-2 offset-sm-9 mt-5 mb-4">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                  ...
                  <div className="container d-flex ">
                    ...
                    <form >
                      <div class="input-group flex-nowrap">
                        <span for="validationDefaultUsername" class="input-group-text" id="addon-wrapping">Name </span>
                        <input type="text" class="form-control" id="form4Example2" aria-label="Username" aria-describedby="addon-wrapping" />
                      </div><br />
                      <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="addon-wrapping">Email </span>
                        <input type="email" class="form-control" aria-describedby="emailHelp" id="form4Example4" aria-label="Username" aria-describedby="addon-wrapping" />
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" data-mdb-dismiss="modal" onClick={e => this.add_new_ele(e)} class="btn btn-primary">Save</button>
              </div>
            </div>
          </div>
        </div>
